...
<body class="bg-white">
    ...
    <div class="px-6 py-4 flex space-x-2">
        <a href="#" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Add New</a>
     ...
     var tabldata = `   <thead>
                ...
                allpost.forEach(post => {
                    ...
                    <tr class="bg-white text-gray-700">
                        ...
                        <td class="px-4 py-2 border text-center">
                            <a href="#" class="bg-green-600 text-white px-3 py-1 rounded hover:bg-green-700">Update</a>
                        </td>
                        <td class="px-4 py-2 border text-center">
